...
# use "grpc" only if your backend supports it
```
...
The SDK logs observability initialization at debug level:
...
Ensure your application can reach the OTLP endpoint:
...
Check that authentication headers are properly URL-encoded.
...
This example demonstrates enabling OpenTelemetry tracing with Laminar
in the OpenHands SDK. Set LMNR_PROJECT_API_KEY and run the script to see traces.
"""
