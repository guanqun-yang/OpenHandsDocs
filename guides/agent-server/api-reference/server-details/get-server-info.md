<!-- Source: https://docs.openhands.dev/sdk/guides/agent-server/api-reference/server-details/get-server-info -->
...
- [Alive](alive.md) - Check if server is running
- [Health](health.md) - Get detailed health status
